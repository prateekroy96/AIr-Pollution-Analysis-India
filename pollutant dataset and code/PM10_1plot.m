station = {'Anand Vihar Delhi';'ITO Delhi';'Maharastra Pollution Control Board Mumbai';'Navi Mumbai Municipal Corp';'Punjabi Bagh Delhi';'R Bharati Unv Kolkata';'R K Puram Delhi';'Victoria Memorial Kolkata'};


for k = 1:8  %10
file_name = strcat(station{k},' PM10.xlsx');
...
headin = strcat('PM10 Concentration Trends in',{' '},station{k});
...
hold off;
saveas(gcf,strcat(station{k},' PM10 1plot.jpeg'));
   %{ 
    %}
