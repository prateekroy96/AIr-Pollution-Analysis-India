station = {'Anand Vihar Delhi';'IIT Chennai';'ITO Delhi';'Maharastra Pollution Control Board Mumbai';'Manali Chennai';'Nehru Nagar Kanpur';'Punjabi Bagh Delhi';'R Bharati Unv Kolkata';'R K Puram Delhi';'Victoria Memorial Kolkata'};


for k = 1:1  %10
file_name = strcat(station{k},' NO2.xlsx');
...
headin = strcat('Nitrogen dioxide Concentration Trends in',{' '},station{k});
...
hold off;
saveas(gcf,strcat(station{k},' NO2 1plot.jpeg'));
   %{ 
    %}
    pol
end