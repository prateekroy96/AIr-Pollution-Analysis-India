station = {'Anand Vihar Delhi';'Dhaka';'IIT Chennai';'ITO Delhi';'Kathmandu Nepal';'Maharastra Pollution Control Board Mumbai';'Manali Chennai';'Navi Mumbai Municipal Corp';'Nehru Nagar Kanpur';'Phora Durbar Nepal';'Punjabi Bagh Delhi';'R K Puram Delhi'};


for k = 1:12
file_name = strcat(station{k},' PM2.xlsx');
...
x1 = x;
y1 = polyval(pol,x1);
p00 = plot(x1,polyval(pol,x1),'color',[0.2 0 0.7]);
hold on
...
headin = strcat('PM2.5 Concentration Trends in',{' '},station{k});
headin = headin + "\n\n\n\n\n";
...
hold off;
saveas(gcf,strcat(station{k},' PM2.jpeg'));
