...
station = {'Anand Vihar Delhi';'Victoria Memorial Kolkata';'Maharastra Pollution Control Board Mumbai';'Nehru Nagar Kanpur';'IIT Chennai';'Maharastra Pollution Control Board Mumbai';'Manali Chennai';'Navi Mumbai Municipal Corp ';'Nehru Nagar Kanpur';'R Bharati Unv Kolkata';'R K Puram Delhi';'Victoria Memorial Kolkata'};
