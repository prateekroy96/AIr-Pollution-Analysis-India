...
station = {'Anand Vihar Delhi';'Victoria Memorial Kolkata';'Maharastra Pollution Control Board Mumbai';'Nehru Nagar Kanpur';'IIT Chennai';'ITO Delhi';'Maharastra Pollution Control Board Mumbai';'Manali Chennai';'Nehru Nagar Kanpur';'Punjabi Bagh Delhi';'R Bharati Unv Kolkata';'R K Puram Delhi';'Victoria Memorial Kolkata'};
