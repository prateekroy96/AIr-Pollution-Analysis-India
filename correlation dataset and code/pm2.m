...
station = {'Anand Vihar Delhi';'Victoria Memorial Kolkata';'Maharastra Pollution Control Board Mumbai';'Nehru Nagar Kanpur';'Manali Chennai';'Nehru Nagar Kanpur';'Dhaka';'IIT Chennai';'ITO Delhi';'Kathmandu Nepal';'Maharastra Pollution Control Board Mumbai';'Manali Chennai';'Navi Mumbai Municipal Corp';'Nehru Nagar Kanpur';'Phora Durbar Nepal';'Punjabi Bagh Delhi';'R K Puram Delhi'};
